...
import deletecontact from'@salesforce/apex/bookAccountData.delguide';
import getContacts from'@salesforce/apex/bookAccountData.getGuideData';
...
const columns = [
    ...
    {label:'Book Name',fieldName:'Company_Name__c'},
