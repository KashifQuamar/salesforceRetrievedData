...
import deletecontact from'@salesforce/apex/bookAccountData.delrec';
import getContacts from'@salesforce/apex/bookAccountData.getBookData';
...
export default class BookData extends LightningElement {
    @api search;
